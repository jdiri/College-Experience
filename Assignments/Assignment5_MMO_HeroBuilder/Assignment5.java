...
//      Lecture: 11:15-12:05
//  Description: create multiple classes to use inheritence to compile a list of heros
//				 with different stats and instance variables
                ...
                if(line.length() == 1){
                    switch (input){
                        ...
                        case 'D': // how many heroes have combat points equal to or larger than a user-defined value
                            ...
                            int count = 0;
                            for(int i = 0;i < playerList.size(); i++) {
                            	int holder = playerList.get(i).getCombatPoints();
                            	if(holder > min) {
                            		count++;
                            	}
                            }
